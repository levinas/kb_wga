...
class WholeGenomeAlignment(object):
    ...
    def run_mugsy(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method run_mugsy: argument json_rpc_context is not type dict as required.')
        resp = self._call('WholeGenomeAlignment.run_mugsy',
